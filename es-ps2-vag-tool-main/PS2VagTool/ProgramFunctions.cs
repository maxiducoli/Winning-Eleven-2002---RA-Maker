...
namespace PS2VagTool
{
    ...
    {
        //-------------------------------------------------------------------------------------------------------------------------------
        public static void ExecuteEncoder(string inputFile, string outputFile, bool forceNoLooping, bool forceLooping)
        {
        ...
        //-------------------------------------------------------------------------------------------------------------------------------
        public static void ExecuteDecoder(string inputFile, string outputFile)
        {
